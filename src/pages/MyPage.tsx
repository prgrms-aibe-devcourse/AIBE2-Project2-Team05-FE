      ...
      <MainContent>
          ...
          <BasicInfo>
            ...
            <FormRow>
              <FormGroup>
                ...
                <FormControl type="text" id="name" placeholder="실명을 입력하세요" />
              </FormGroup>
              <FormGroup>
                <FormLabel htmlFor="nickname">닉네임</FormLabel>
                <FormControl type="text" id="nickname" placeholder="사용할 닉네임을 입력하세요" />
              </FormGroup>
            </FormRow>
            <FormRow>
              <FormGroup>
                <FormLabel htmlFor="age">나이</FormLabel>
                <FormControl type="number" id="age" placeholder="만 나이를 입력하세요" />
              </FormGroup>
              <FormGroup>
                <FormLabel>성별</FormLabel>
                <RadioGroup>
                  <label><input type="radio" name="gender" defaultChecked /> 남성</label>
        ...
        <PreferenceSection>
            ...
            <FormGroup>
             ...
             <FormGroup>
                ...
                <CheckboxGroup>
                    <label><input type="checkbox" defaultChecked /> 계획적인 여행</label>
                    <label><input type="checkbox" /> 즉흥적인 여행</label>
                    <label><input type="checkbox" defaultChecked /> 관광 중심</label>
                    <label><input type="checkbox" /> 휴식 중심</label>
                </CheckboxGroup>
            </FormGroup>
        </PreferenceSection>
        ...
        <Section>
            ...
            <FormGroup>
                ...
                <TextareaControl id="bio" rows={4} placeholder="여행 동반자에게 자신을 소개해보세요." />
            </FormGroup>
        </Section>
        ...
        <Section>
          ...
          <FormGroup>
            ...
            <FormControl type="text" id="username" defaultValue="Traveler_Kim" disabled />
          </FormGroup>
          <FormRow>
            <FormGroup>
              <FormLabel htmlFor="new-password">새 비밀번호</FormLabel>
              <FormControl type="password" id="new-password" placeholder="새 비밀번호" />
            </FormGroup>
            <FormGroup>
              <FormLabel htmlFor="confirm-password">새 비밀번호 확인</FormLabel>
              <FormControl type="password" id="confirm-password" placeholder="새 비밀번호 확인" />
            </FormGroup>
          </FormRow>
        </Section>
