...
public class ProfileService {
    ...
    private ProfileResponseDto buildProfileResponse(User user) {
        ...
        ProfileResponseDto response = ProfileResponseDto.builder()
                ...
                .email(user.getEmail())
                .realName(user.getProfile() != null ? user.getProfile().getRealName() : null)
                ...
                .preferredDestinations(user.getProfile() != null ? user.getProfile().getPreferredDestinations() : "유럽")
                .travelStyle(user.getProfile() != null ? user.getProfile().getTravelStyle() : "계획적인 여행,관광 중심")
